							...
							<tr>
								...
								<td class="t1" rowspan="3" style="vertical-align:baseline;">
									<strong>Expectations:</strong>
										<p style="font-size: 14px;">In the midst of a bustling city, where towering 
											...
											escape from the chaos outside. It was a haven of tranquility, where time seemed 
											to slow, and the world felt a little bit kinder.</p>
								</td>
							</tr>
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="2" rowspan="2" align="center" style="vertical-align:middle;">
											...
											<h3 class="nomargin"><strong>RASI</strong></h3>
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="2" rowspan="2" align="center" style="vertical-align:middle;">
											...
											<h3 class="nomargin"><strong>AMSAM</strong></h3>
...
<script>
    document.getElementById('download').addEventListener('click', function() {
        window.location.href = '{{ route('view.pdf') }}';
    });
</script>

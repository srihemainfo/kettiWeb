        ...
        <div class="row user-details-main my-3">
            ...
            <div class="col-lg-5">
                <div class="pv-user-details-main">
                    ...
                    <p ><span> <i class="fal fa-book"></i> </span>BSC, Web / Graphic Designer</p>
                    <p><span> <i class="fal fa-calendar-alt"></i> </span>Hindu, Malayalee / Keralites</p>
                    <p ><span> <i class="fal fa-location"></i> </span>K.K.Nagar</p>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="pv-user-details-main">
                    <p style="font-weight: 600; text-transform: uppercase;"> <span> <i class="fal fa-heart"></i> </span><a data-bs-toggle="modal" data-bs-target="#exampleModal" class="pop-a" style="text-decoration:none;">Express Interest</a></p>
           <p style="font-weight: 600; text-transform: uppercase;"> <span> <i class="fal fa-phone"></i> </span><a data-bs-toggle="modal" data-bs-target="#exampleModal" class="pop-a" style="text-decoration:none;">Contact</a></p>
           <p style="font-weight: 600; text-transform: uppercase;"> <span> <i class="fal fa-plus"></i> </span>Added</p>
           <p style="font-weight: 600; text-transform: uppercase;"> <span> <i class="fal fa-minus"></i> </span>Block Member</p>
           <p style="font-weight: 600; text-transform: uppercase;"> <span> <i class="fal fa-flower"></i> </span>Like Profile</p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6" style="border-right:2px solid #ddd;">
                                <p class="pkg-name gold-pkg">Package Gold</p>
                                <p class="pkg-subname py-3">Pin Rate: 70</p>
                                <p class="pkg-subname py-3">Wallet Amount: Rs 0</p>
                                <p class="pkg-subname py-3">Used Pin: 28</p>
                                <p class="pkg-subname py-3">Unused Pin: 0</p>
                            </div>
                            <div class="col-md-6">
                               
                                <div class="next-btn text-center">
                                    <button class="close-btn-green" data-bs-dismiss="modal"><img src="images/iconoir_cancel.webp"></button>
                                </div>
                                
                                <p class="pkg-subname py-3">Contact Person</p>
                                <p class="pkg-name">Thirunavukarasu</p>
                                <p class="pkg-subname py-3">Mobile</p>
                                <p class="pkg-name">6379163256</p>
                                <p class="pkg-subname py-3">Email ID</p>
                                <p class="pkg-name">Not Uploaded</p>

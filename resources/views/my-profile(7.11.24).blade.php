         ...
         <div class="row">
           <div class="col-lg-3">
             <div class="tab--section d-none d-lg-flex" id="myTab" role="tablist">
                 <div class="pr-sec text-center">
              <img src="images/My Profile/main-user-img.webp" alt="user-img">
              <h2 class="km-id">KM10093</h2>
             <div class="wrapper mt-3 mb-3">
               ...
               <div class="tab--item" role="presentation">
                 <button class="tab--btn active" id="bride-tab" data-bs-toggle="tab" data-bs-target="#bride" type="button" role="tab" aria-controls="bride" aria-selected="true"><i class="fas fa-people-arrows" style="font-size:23px;"></i> Bride / Groom Profile</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="family-tab" data-bs-toggle="tab" data-bs-target="#family" type="button" role="tab" aria-controls="family" aria-selected="false"><i class="fas fa-house-user" style="font-size:23px;"></i> Family Details</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="address-tab" data-bs-toggle="tab" data-bs-target="#address" type="button" role="tab" aria-controls="address" aria-selected="false"> <i class="fas fa-address-card" style="font-size:23px;"></i> Address Details</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="partner-tab" data-bs-toggle="tab" data-bs-target="#partner" type="button" role="tab" aria-controls="partner" aria-selected="false"> <i class="fas fa-hands-helping" style="font-size:23px;"></i> Partner Preference</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="horoscope-tab" data-bs-toggle="tab" data-bs-target="#horoscope" type="button" role="tab" aria-controls="horoscope" aria-selected="false"><i class="fas fa-star-of-david" style="font-size:23px;"></i> Horoscope Details</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="interest-tab" data-bs-toggle="tab" data-bs-target="#interest" type="button" role="tab" aria-controls="interest" aria-selected="false"><i class="fab fa-gratipay" style="font-size:23px;"></i> Hobbies & Interest</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="education-tab" data-bs-toggle="tab" data-bs-target="#education" type="button" role="tab" aria-controls="education" aria-selected="false"><i class="fas fa-school" style="font-size:23px;"></i> Education & Occupation</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="habits-tab" data-bs-toggle="tab" data-bs-target="#habits" type="button" role="tab" aria-controls="habits" aria-selected="false"> <i class="fas fa-glass-whiskey" style="font-size:23px;"></i> Habits</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="location-tab" data-bs-toggle="tab" data-bs-target="#location" type="button" role="tab" aria-controls="location" aria-selected="false"><i class="fas fa-map-marker-alt" style="font-size:23px;"></i> Location Details</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="physical-tab" data-bs-toggle="tab" data-bs-target="#physical" type="button" role="tab" aria-controls="physical" aria-selected="false"><i class="fas fa-child" style="font-size:23px;"></i> Physical Attributes</button>
               </div>
               <div class="tab--item" role="presentation">
                 <button class="tab--btn" id="intercaste-tab" data-bs-toggle="tab" data-bs-target="#intercaste" type="button" role="tab" aria-controls="intercaste" aria-selected="false"><i class="fas fa-praying-hands" style="font-size:23px;"></i> For Intercaste Parents</button>
               </div>
               <div class="tab--item" role="presentation">

        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6" id="main_profile_screen">
                    ...
                    <div id="aft-login">
                        <h2 class="aft-login-head">Communication Address and Details</h2>
                        <div class="request-box row">
                            <form class="mt-3">
                                ...
                                <input type="number" class="form-control" Placeholder="Enter Contact Person Mobile No ">
                                    </div>
                                ...
                                <input type="text" class="form-control"Placeholder="Enter Your Door No & Street" >
                                </div>
                                 <div class="col-md-6 mb-3">

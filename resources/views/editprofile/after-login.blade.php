...
.requests1 a{
    background: rgb(13, 172, 95);
    background: linear-gradient(90deg, rgba(13, 172, 95, 1) 0%, rgba(92, 186, 82, 1) 100%);
    color: #fff;
            ...
            <div class="row">
                    ...
                    <div class="green-bg">
                        <div class="profile-main text-end">
                            ...
                            <div class="w-100 d-flex  align-items-center "
                                style="justify-content: end;margin-top: -30px;">
                        ...
                        <div class="profile-secondary">
                            <div class="list-sec mt-4">
                                <ul>
                                    <li id="bg-profile" class="{{ request()->routeIs('bride-groom') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('bride-groom') }}'"
                                        style="cursor: pointer;">
                                        <span class="icon"> <img
                                                src="images/after login/icon edit profile 1.webp"></span>
                                        <span class="description">Edit Profile</span>
                                    </li>

                                    <li id="fam-det" class="{{ request()->routeIs('family-details') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('family-details') }}'"
                                        style="cursor: pointer;">
                                        <span class="icon"> <img
                                                src="images/after login/icon edit profile 2.webp"></span>
                                        <span class="description">Edit Preference</span>
                                    </li>

                                    <li id="add-det" class="{{ request()->routeIs('address-details') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('address-details') }}'"
                                        style="cursor: pointer;">
                                        <span class="icon"> <img
                                                src="images/after login/icon edit profile 3.webp"></span>
                                    ...
                                    <!-- </li>-->
                                    <li id="par-prefer"
                                        class="{{ request()->routeIs('partner-preference') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('partner-preference') }}'"
                                        style="cursor: pointer;">
                                    ...
                                    <li id="par-prefer"
                                        class="{{ request()->routeIs('horoscope-details') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('horoscope-details') }}'"
                                        style="cursor: pointer;">
                                    ...
                                    <li id="par-prefer"
                                        class="{{ request()->routeIs('hobbies-interest') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('hobbies-interest') }}'"
                                        style="cursor: pointer;">
                                    ...
                                    <li id="edu-detail"
                                        class="{{ request()->routeIs('education-occupation') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('education-occupation') }}'"
                                        style="cursor: pointer;">
                                    ...
                                    <li id="edu-detail" class="{{ request()->routeIs('habits') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('habits') }}'" style="cursor: pointer;">
                                    ...
                                    <li id="loc-detail"
                                        class="{{ request()->routeIs('location-detail') ? 'active' : '' }}"
                                        onclick="window.location.href='{{ route('location-detail') }}'"
                                        style="cursor: pointer;">
                ...
                <div class="col-lg-9">
                    <div class="welcome-message my-3">
                        <p>Welcome Mr T.Natarajan <img src="images/after login/waving-hand 1.webp" alt="waving-hand">
                        </p>
                        <h2 class="aft-login-head1">Your profile is pending verification! Verify now to get better
                            responses<a href="">Verify Profile</a></h2>
                    </div>
               <!--<div class="request-box1 row mt-4 mb-4">-->
               ...
               <!--                 <a class="upgrade-btn" href="#" contenteditable="false" style="cursor: pointer;">-->
               <!--                     Upgrade-->
               <!--                 </a>-->
               <!--             </div>-->
               <!--         </div>-->
                   <div class="requests col-lg-8" style="display: flex; gap: 10px; align-items: center;">
                    <a href="#" contenteditable="false" style="cursor: pointer;">
                        <img src="images/after login/mini-heart.webp" alt="mini-heart">  <span>(4)</span>
                    </a>
                    <a href="#" contenteditable="false" style="cursor: pointer;">
                        <img src="images/after login/mini-photo.webp" alt="mini-photo">  <span>(2)</span>
                    </a>
                    <a href="#" contenteditable="false" style="cursor: pointer;">
                        <img src="images/after login/mini-doc.webp" alt="mini-doc"> <span>(0)</span>
                    </a>
                    <a href="#" contenteditable="false" style="cursor: pointer;">
                        <img src="images/after login/mini-call.webp" alt="mini-call">  <span>(1)</span>
                    </a>
                    <a href="#" contenteditable="false" style="cursor: pointer;">
                        <img src="images/after login/mini-send.webp" alt="mini-send"> <span></span> <span>(5)</span>
                    </a>
                </div>

                    <div class="web-title wow fadeInUp" data-wow-duration="1s" style="text-align:start;">
                        <h3>Similiar Profile</h3>
                    </div> 
                    ...
                    <div class="request-box row mt-4">
                        ...
                        <div>
                            ...
                            <div class="request-box row mt-4 justify-content-center">
                                    ...
                                    <div class="col-lg-3  col-md-6 wow fadeInUp" data-wow-duration="2s">
                                        <div class="profile-box">
                                            <div class="profile-img">
                                                ...
                                                <img
                                                    src="images/1568808112_WhatsApp Image 2019-09-16 at 11.14.12 PM.jpeg">
                                            </div>
                                            <div class="profile-details">
                                                ...
                                                <ul class="groo-ul m-0 ">
                                                    <li class="groom-li"><a href="#" class="view-pp"
                                                            data-bs-toggle="modal" data-bs-target="#login1"
                                                            contenteditable="false" style="cursor: pointer;">ID
                                                            <span>KM4372</span></a></li>
                                                    <li class="groom-li"><a href="#" class="profile-btn"
                                                            data-bs-toggle="modal" data-bs-target="#login1"
                                                            contenteditable="false" style="cursor: pointer;">View
                                                            Profile</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="row" id="brides-list">
                                    <div class="tab-pane fade active show" id="bride" role="tabpanel"
                                        aria-labelledby="bridetab">
                                                        ...
                                                        <div class="profile-details">
                                                            ...
                                                            <ul class="groo-ul m-0 ">
                                                                <li class="groom-li"><a href="#" class="view-pp"
                                                                        ...
                                                                        data-bs-target="#login1">ID
                                                                        <span>KM1970</span></a></li>
                                                                <li class="groom-li"><a href="#" class="profile-btn"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#login1">View Profile</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-3  col-md-6 wow fadeInUp" data-wow-duration="2s">
                                                <div class="profile-box">
                                                    ...
                                                    <div class="profile-details">
                                                        ...
                                                        <ul class="groo-ul m-0 ">
                                                            <li class="groom-li"><a href="#" class="view-pp"
                                                                    data-bs-toggle="modal" data-bs-target="#login1">ID
                                                                    <span>KM1758</span></a></li>
                                                            <li class="groom-li"><a href="#" class="profile-btn"
                                                                    data-bs-toggle="modal" data-bs-target="#login1">View
                                                                    Profile</a></li>
                                                        </ul>
                                                    </div>
                                                </div>

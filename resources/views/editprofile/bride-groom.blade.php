                            ...
                            <div class="user-details">
                                <div class="user-profile-pic">
                                    <img src="images/after login/profile-main.webp" alt="profile-main"
                                        data-bs-toggle="modal" data-bs-target="#profilePopup" style="cursor:pointer;">
                                </div>
                        ...
                        <div class="request-box row">
                            <form class="mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label" style="color: #868686;">Date of Birth*</label><input
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example">
                                            ...
                                            <option value="Widow with children">Widow / Widower with Children / Child
                                            </option>
                                            <option value="Widow without children">Widow / Widower without Children /
                                                Child</option>
                                            <option value="Divorce with children">Divorce with Children / Child
                                            </option>
                                            <option value="Divorce without children">Divorce without Children / Child
                                            </option>
                                            <option value="Awaiting Divorce with children">Awaiting Divorce with
                                                Children / Child</option>
                                            <option value="Awaiting Divorce without children">Awaiting Divorce without
                                                Children / Child</option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example">
                                            ...
                                            <option class="default" value="51" selected="selected">Tamil</option>
                                    ...
                                    <div class="col-md-6 mb-3 mt-4">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="caste-no-barOptions"
                                                id="caste-no-barOptions1" value="option1">
                                            <label class="form-check-label" for="caste-no-barOptions1">Yes</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="caste-no-barOptions"
                                                id="caste-no-barOptions2" value="option2">

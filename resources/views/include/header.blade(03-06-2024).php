                                ...
                                <form action="#" id='personal_form'>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="createdfor" id="createdfor">
                                         ...
                                         <p class="validate_errors" id="createdfor_error"
                                    style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Name</label>
                                        <input type="text" class="form-control" placeholder="Enter Name" name="name" id="name">
                                        <p class="validate_errors" id="name_error" style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                    </div>
                                    <div class="mb-3">
...
<script>
  ...
  function validateAndOpenModal(modalId) {
    if (validateFormData()) {
        $(modalId).modal('show'); // Open the specified modal if validation succeeds
    } else {
        // Show error message or handle invalid form data
        $('.validate_errors').text('Please fill out all required fields.').show();
    }
}
  ...
  function validateAndOpenModal(modalId) {
    ...
    if ($('#createdfor_error').text() === '') {
       
                $('#createdfor_error').text('Validation error message');
    } else {

        ...
        <div class="slider">
            ...
            <div class="form-container">
                ...
                <div class="form-box wow fadeInUp" data-wow-duration="2s">
                    ...
                    <select class="form-control" style="line-height: 1;padding: 12px 17px;">
                ...
                <div class="form-box wow fadeInUp" data-wow-duration="2s" data-wow-delay=".3s">
                    ...
                    <select name="age_from" id="age_from" class="form-control" style="line-height: 1;padding: 12px 17px;">
                 ...
                 <div class="form-box wow fadeInUp" data-wow-duration="2s" data-wow-delay=".3s">
                    ...
                    <select name="age_to" id="age_to" class="form-control" style="line-height: 1;padding: 12px 17px;">
                ...
                <select name="religions" id="religions" class="form-control" style="line-height: 1; padding: 12px 17px;">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", async function() {
                    const apiUrl = 'https://api.kettimelammatrimony.com/api/religion';
                    const religionSelect = document.getElementById('religions');
                    ...
                    try {
                        ...
                        // Verify response structure and code
                        if (data.code === 200 && data.data && data.data.religion) {
                            data.data.religion.forEach((religion) => {
                                const option = document.createElement('option');
                                option.value = religion.id;
                                option.textContent = religion.religion;  // Display religion name in English
                ...
                <div class="form-box wow fadeInUp" data-wow-duration="2s" data-wow-delay=".9s">
                    ...
                    <select name="motherTongue" id="motherTongue" class="form-control" style="line-height: 1; padding: 12px 17px;">
                ...
                <script>
                    $(document).ready(function() {
                        // API URL
                        const apiUrl = 'https://api.kettimelammatrimony.com/api/mother_tongue';
            
                        // Fetch the mother tongue data
                        $.get(apiUrl, function(response) {
                            // Check if the response code is 200
                            if (response.code === 200) {
                                // Loop through the mother tongues and append to the dropdown
                                response.data.m_tongue.forEach(function(item) {
                                    $('#motherTongue').append(
                                        `<option value="${item.id}">${item.mtongue}</option>` //(${item.mtongue_tamil})
                                    );
                                });
                            } else {
                                console.error('Failed to fetch mother tongue data');
                            }
                        }).fail(function() {
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="row" id="testimonials">
                        <div class="col-lg-4" data-wow-duration="2s">
                ...
                <div class="col-lg-12 wow fadeInUp">
                    <div class="default-content text-center mt-4">
                        <a data-bs-toggle="modal" data-bs-target="#login1" class="btn-web-green-big">View More</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-5 col-md-6 col-md-6 p-0 wow fadeInLeft" data-wow-duration="2s">
                    <div class="doll-sec">
                        <div class="default-content text-center bg-box ">
                            <div class="con-img">
                                <img src="images/doll-2.png" alt="" style="width:100px;height: 100px;">
                            </div>
                            <h3>Customer care</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-duration="2s">
                    ...
                    <div class="default-content text-center m-3">
                        ...
                        <a data-bs-toggle="modal" data-bs-target="#register1" class="btn-web-green-big">Register Now</a>
        ...
        <div class="container">
            <div class="row" style="align-items: center;">
                ...
                <div class="col-lg-6 col-md-12 text-center wow fadeInUp" data-wow-duration="2s"
                    data-wow-delay=".5s">
                    <div class="green-btn">
                        <a class="grn-btn" data-bs-toggle="modal" data-bs-target="#login1">
                            Get Started
                        </a>
                    </div>
                </div>

        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="dropdown dropdown-2" style="border: 2px solid #6f0e5c;">
                        <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <img src="images/My Profile/eye-icon-pink.webp" alt="eye-icon"> Profile View
                        </button>
            ...
            <div class="row user-details-main my-3"
                style="background-color: #fde9fa; border:none; box-shadow: 0px 3px 5px 0px rgba(0, 0, 0, 0.5);">
                <div class="col-lg-3 text-center mb-3">
                    <img src="images/My Profile/main-user-img-female.webp" alt="user-img" width="80%">
                </div>
                <div class="col-lg-1"></div>
                <div class="col-lg-8">
                    <div class="pv-user-details-main">
                        <p style="font-weight: 600; text-transform: uppercase;"> <span> <i class="fal fa-user"
                                    style="background: #6f0e5c;"></i> </span> T.Nagarajan</p>
                        <p> <span> <i class="fal fa-calendar-alt" style="background: #6f0e5c;"></i> </span> 29 years ago
                        </p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2" rowspan="2" align="center"
                                    style="vertical-align:middle; background-color: #f2f2f2;">
                                    <h3 style="color: #00A859;">RAASI</h3>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                    ...
                    <table class="table-2" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2" rowspan="2" align="center"
                                    style="vertical-align:middle; background-color: #f2f2f2;">
                                    <h3 style="color: #00A859;">AMSAM</h3>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>

                        ...
                        <div class="register-popup-main">
                            ...
                            <div class="resgiter-form-div">
                                <form action="#" id="personal_form">
                                    ...
                                    <div class="next-btn text-center mb-4">
                                        <a href="#" class="btn btn-primary" onclick="validateAndOpenModal('#register2')" data-bs-toggle="modal" data-bs-target="#register2" data-bs-dismiss="modal">Next</a>
                                    </div>
                                    <div class="login-link text-center">
                        ...
                        <div class="register-popup-main">
                            ...
                            <div class="register-form-div">
                                <form action="#" id="registration_form">
                                    ...
                                    <div class="next-btn text-center mb-4">
                                        <a href="#" onclick="validateAndOpenModal('#register1')">Register</a>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
    ...
    ////// LOG IN /////
      ...
      function validateAndOpenModal(modalId) {
        ...
        const fields = [
            { field: '#createdfor', error: '#createdfor_error' },
            { field: '#customer_name', error: '#customer_name_error' },
            { field: '#gender', error: '#gender_error' },
            { field: '#dob', error: '#dob_error' },
            { field: '#marital_status', error: '#marital_status_error' },
            { field: '#no_of_child', error: '#no_of_child_error' },
            { field: '#child_status', error: '#child_status_error' },
            { field: '#religion', error: '#religion_error' },
            { field: '#sub_religion', error: '#sub_religion_error' },
            { field: '#caste', error: '#caste_error' },
            { field: '#sub_caste', error: '#sub_caste_error' },
            { field: '#physicalstatus', error: '#physicalstatus_error' },
            { field: '#challenge', error: '#challenge_error', visibleCheck: true },
            { field: '#otherchallenge', error: '#otherchallenge_error', visibleCheck: true },
            { field: '#mother_tongue', error: '#mother_tongue_error' },
            { field: '#educationCategory', error: '#educationCategory_error' },
            { field: '#employed_in', error: '#employed_in_error' },
            { field: '#occupation', error: '#occupation_error' },
            { field: '#father_name', error: '#father_name_error' },
            { field: '#emailID', error: '#emailID_error' },
            { field: '#mobile_no', error: '#mobile_no_error' },
            { field: '#whatsapp_no', error: '#whatsapp_no_error' },
            { field: '#monthly_income', error: '#monthly_income_error' },
            { field: '#country_living', error: '#country_living_error' },
            { field: '#username', error: '#username_error' },
            { field: '#password', error: '#password_error' },
            { field: '#password2', error: '#password2_error' },
        ];
    
        // Perform validation checks
        fields.forEach(({ field, error, visibleCheck }) => {

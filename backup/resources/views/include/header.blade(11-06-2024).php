                            ...
                            <div class="resgiter-form-div">
                                <form action="#" id='personal_form'>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="validate_errors" id="gender_error"></p>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <p class="validate_errors" id="marital_status_error"></p>
                                    </div>
                                    ...
                                    <div class="mb-5" style="display: none;" id="children_fields">
                                        ...
                                        <p class="validate_errors" id="no_of_child_error"></p>
                                    
                                        <label class="form-label">Children Status</label>
                                        <input type="name" class="form-control" name="child_status" id="child_status" min="0">
                                        <p class="validate_errors" id="child_status_error"></p>
                                    </div> 
                                    
                                    
                                    <div class="next-btn text-center mb-4">
                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" onclick="validateAndOpenModal('#register2')" data-bs-target="#register2" data-bs-dismiss="modal">Next</a>
                                    </div>
                                    <div class="login-link text-center">
                            ...
                            <div class="resgiter-form-div">
                                <form action="#">
                                    <div class="mb-3">
                                        ...
                                        <p class="validate_errors" id="religion_error"></p>
                                    </div>
...
<script>
    ...
    ////// LOG IN /////
      ...
      function validateAndOpenModal(modalId) {
        ...
        if ($('#createdfor').val() === '') {
            $('#createdfor_error').text('Please select an option for Profile For').show();
        } else if ($('#customer_name').val() === '') {
            $('#customer_name_error').text('Please enter your Name').show();
        } else if ($('#gender').val() === '') {
            $('#gender_error').text('Please select your Gender').show();
        } else if ($('#marital_status').val() === '') {
            $('#marital_status_error').text('Please select your Marital Status').show();
        } else if ($('#no_of_child').val() === '') {
            $('#no_of_child_error').text('Please enter the Number of Children').show();
        } else if ($('#child_status').val() === '') {
            $('#child_status_error').text('Please enter the Children Status').show();
        } else if ($('#religion').val() === '') {
            $('#religion_error').text('Please select your Religion').show();
        } else if ($('#sub_religion').val() === '') {
            $('#sub_religion_error').text('Please select your Sub-Religion').show();
        } else if ($('#caste').val() === '') {
            $('#caste_error').text('Please select your Caste').show();
        } else if ($('#sub_caste').val() === '') {
            $('#sub_caste_error').text('Please select your Sub-Caste').show();
        } else if ($('#physicalstatus').val() === '') {
            $('#physicalstatus_error').text('Please select your Physical Status').show();
        } else if ($('#challenge').val() === '') {
            $('#challenge_error').text('Please select your Challenge').show();
        } else if ($('#otherchallenge').val() === '') {
            $('#otherchallenge_error').text('Please enter other Challenges').show();
        } else {
            $(modalId).modal('show'); // Open the modal if validation passes
        }
    }

        ...
        <div class="slider">
            ...
            <div class="form-container">
                ...
                <div class="form-box wow fadeInUp" data-wow-duration="2s" data-wow-delay=".3s">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-light dropdown-toggle" type="button" id="age" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            From
                        </button>
                ...
                <div class="col-lg-11">
                    <div class="doggle-div mb-3">
                        <ul class="nav nav-tabs select-gender-tab" id="myTab" role="tablist">
                            <li class="nav-item wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" role="presentation">
                            ...
                            <li class="nav-item wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s" role="presentation">
                    ...
                    <div class="modal-dialog modal-dialog-centered  modal-lg">
                        <div class="modal-content bg-transparant">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="default-content">
                                    <iframe src="https://www.youtube.com/embed/9j89dmRTGx8" title="YouTube video player"
                                        frameborder="0"
                    ...
                    <div class="modal-dialog modal-dialog-centered  modal-lg">
                        <div class="modal-content bg-transparant">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="default-content">
                                    <iframe src="https://www.youtube.com/embed/MM6EygDy-dI" title="YouTube video player"
                                        frameborder="0"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                        allowfullscreen></iframe>
                                </div>

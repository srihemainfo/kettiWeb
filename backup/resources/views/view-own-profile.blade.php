    ...
    <section class="profile-main-section">
        <div class="container">
            ...
            <div class="row user-details-main my-3"
                style="background-color: #edfff7; border:none; box-shadow: 0px 3px 5px 0px rgba(0, 0, 0, 0.5);">
                ...
                <div class="col-lg-8">
                    <div class="pv-user-details-main">
                        <p style="font-weight: 600; text-transform: uppercase;"> <span> <i class="fal fa-user"></i>
                            </span> T.Nagarajan</p>
